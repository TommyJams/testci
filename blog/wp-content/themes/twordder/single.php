<?php get_header(); ?>
    <div id="yui-main"> 
	   ...
	   <?php comments_number('No Comments','1 Comment','% Comments'); ?><img src="<?php bloginfo('template_url'); ?>/images/comment.png" alt="Comments" class="comment-img"/>
        </div> 
<div class="clear"></div>
