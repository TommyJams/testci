...
?>
				...
				<p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'adventurejournal' ),
						'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'adventurejournal' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
						$total_images
					); ?></em></p>
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'adventurejournal') ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <?php edit_post_link( __( 'Edit', 'adventurejournal' ), '<span class="edit-link">', '</span>' ); ?>
