...
<?php
	...
	if (is_category("MusicLabs")) {
		$musiclabs_menu = 'current_page_item';
	} else {
		$musiclabs_menu = 'page_item';
	}
	if (is_category("BanjaraTalkies")) {
		$banjara_menu = 'current_page_item';
	} else {
		$banjara_menu = 'page_item';
	}
