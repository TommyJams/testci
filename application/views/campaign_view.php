        ...
        <div class="d-tj-offset-top-30 d-tj-artist" >
          ...
          <div>
            <ul class=" list-unstyled social-list-share clear-fix">
              <li><a href="#" title="Share on Facebook" class='social-list-facebook-share pull-left' onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(location.href), 'facebook-share-dialog', 'width=626,height=436'); return false;"></a></li>
              <li><a href="#" title="Share on Twitter"  class='social-list-twitter-share pull-right'  onclick="window.open('https://twitter.com/share?u='+encodeURIComponent(location.href), 'width=626,height=436'); return false;" data-related="jasoncosta" data-lang="en" data-size="large" data-count="none"></a></li>
            </ul>
            <div class="clearfix"></div>
            <?
            if($fbEventURL)
