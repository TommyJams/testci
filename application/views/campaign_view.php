      ...
      <div class="col-md-7 d-tj-artist" >
        ...
        <div>
          <ul class=" list-unstyled social-list clear-fix">
            ...
            <li ><a href="#" class="social-list-twitter"  onclick="window.open('https://twitter.com/share, 'width=626,height=436');" data-related="jasoncosta" data-lang="en" data-size="large" data-count="none"></a></li >
          </ul>
        </div>      
      </div> 
    </div>
