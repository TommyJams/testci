        ...
        <div class="d-tj-offset-top-30 d-tj-artist" >
          ...
          <div>
            <ul class=" list-unstyled social-list-share clear-fix">
              ...
              <li><a title="Share on Twitter" class="twitter-share-button" class='social-list-twitter-share' href="https://twitter.com/share" target="_blank" data-lang="en" data-text="<?print($artist_name);?> is touring with TommyJams and coming to a venue near you. Pre-book your tickets now! \nTarget Sales: <? print($target); ?>"></a>
