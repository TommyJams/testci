        ...
        <div class="d-tj-offset-top-30 d-tj-artist" >
          ...
          <div>
            <ul class=" list-unstyled social-list-share clear-fix">
              <li><a style="margin-right: 10px;" href="#" title="Share on Facebook" class='social-list-facebook-share' onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(location.href), 'facebook-share-dialog', 'width=626,height=436'); return false;"></a></li>
