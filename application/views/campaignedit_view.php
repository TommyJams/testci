...
var addoption = '<div id="t1" class="pledge"><h4><input  class="form-control input-lg pull-left" type="text" name="document.write(a);" placeholder="<p id="pholder"></p>"><i class=" btn-delete-pledge pull-right">-</i></h4><div class="clearfix"></div>';
