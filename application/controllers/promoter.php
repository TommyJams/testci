				...
				if($status==1)
				{
					...
					<table border='1'>
						...
						<tr>
							...
							<td><a href='<? php print(base_url()) ;?>artist/feedback/$link'>RATE</a> (enabled only after the gig)</td>
						</tr>
					</table>
					</center>
					";
				...
				$mess="<p style='text-align:left;'>
					...
					<table border='1'>
						...
						<tr>
							...
							<td><a href='<? print(base_url().'promoter/feedback/$link'); ?>'>RATE</a> (enabled only after the gig)</td>
						</tr>
					</table>
					</center>
					";
